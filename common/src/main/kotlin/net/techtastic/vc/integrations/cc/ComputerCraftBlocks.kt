...
object ComputerCraftBlocks {
    ...
    @JvmField
    var RADAR = BLOCKS.register("radar_cc") {
        Block(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }
    @JvmField
    var READER = BLOCKS.register("reader_cc") {
        Block(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }
    @JvmField
    var MOTOR = BLOCKS.register<Block>("motor_cc") {
        MotorBaseBlock(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }

    var TOP = BLOCKS.register<Block>("top_cc") {
        TopBlock(BlockBehaviour.Properties.of(Material.METAL).strength(2.0f))
    }
